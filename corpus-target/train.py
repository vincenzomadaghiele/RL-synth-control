...
if __name__ == "__main__":
	...
	training_parameters["corpus_path"] = './00_corpus/00_moisesdb/guitar'
	...
	training_parameters["N_reward_memory"] = 2
	training_parameters["step_size"] = 1
	training_parameters["rewards"] = ['RMSdifference', 'featureDifference']
	training_parameters["normalization_mode"] = 'separate'
	...
	logdir = f'RL_continuous/corpus-domain/00_model_logs/{str(today)}/{agent_name}'
